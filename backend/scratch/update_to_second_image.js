...
const srcFile = 'media__1779356755639.png'; // Second image timestamped 1779356755639
const destFile = 'mobile_app_promo_new.png';

const run = async () => {
    try {
        console.log('1. Copying second uploaded user image...');
        ...
        const appSection = await HomepageSection.findOneAndUpdate(
            { id_name: 'app_promo' },
            { data: { image: '/uploads/homepage/mobile_app_promo_new.png' } },
            { new: true }
        );
